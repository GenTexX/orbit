//! prism color math: HSV/RGB/hex conversions and the gradient bitmaps the color
//! picker draws (an SV square, a hue bar, an alpha bar). Copied from atlas's
//! color module; both should move to a shared crate (see model.rs).
